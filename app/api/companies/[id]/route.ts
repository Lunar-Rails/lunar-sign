...
async function generateUniqueSlug(baseSlug: string, currentCompanyId: string, supabase: Awaited<ReturnType<typeof createClient>>) {
...
export async function PATCH(
  ...
  try {
    ...
    const slug = await generateUniqueSlug(toSlug(name), id, supabase)
    ...
    await logAudit(user.id, 'company_updated', 'company', id, {
...
export async function DELETE(
  ...
  try {
    ...
    await logAudit(user.id, 'company_deleted', 'company', id)
